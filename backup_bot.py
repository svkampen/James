...
class James(IRCHandler):
    ...
    def __init__(self, config, verbose=False):
        ...
        # Data
        self.data = {'autojoin_channels': CONFIG['autojoin']}
        self.data['events'] = self.initialize_events()
    ...
    def initialize_events(self):
        events = {}
        for item in utils.events.StandardEvents:
            events.update({item: Event()})
        return events

    def welcome(self, msg):
        """ welcome(msg) - handles on-login actions """
        self.msg(CONFIG['identify_service'], 'identify %s' % (CONFIG['ident_pass']))
        self.data['events']['WelcomeEvent'].fire(self)
    ...
    def privmsg(self, msg):
        ...
        self.data['events']['MessageEvent'].fire(self, nick, chan, msg)
    ...
    def join(self, msg):
        ...
        self.data['events']['JoinEvent'].fire(self, user, channel)
